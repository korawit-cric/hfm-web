    ...
    >
      {faqs.map((faq) => (
        <AccordionItem key={faq.id} value={String(faq.id)}>
          <AccordionTrigger
            className={cn(
              'border-light-border-gray border-b p-5 text-base font-normal md:p-5 md:text-xl',
          ...
          <AccordionContent className="border-light-border-gray border-b text-sm font-normal md:text-base [&>div]:p-5 md:[&>div]:p-5">
