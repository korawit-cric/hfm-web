...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const baseInputStyles = cn(
      'h-[42px] w-full max-w-full rounded-lg bg-white px-4 text-darkest-gray placeholder:text-medium-gray transition-all duration-200 text-mobile-body1 md:text-desktop-body1',
      icon && 'pr-10',
    );
